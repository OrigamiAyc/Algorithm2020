...
\titleformat{\chapter}{\centering\huge\bfseries}{第~四~次作业}{1em}{}
...
\theoremstyle{plain} \newtheorem{lemma}{lemma}[section] %引理
	...
	\section{红黑树}
		...
		\begin{figure}[h!]
			...
			\begin{minipage}{40em}
				\centering
				\includegraphics[scale = 0.07]{images/1_a.jpg}
			\end{minipage}
		\end{figure}
		\subsection{删除结点}
		\begin{figure}[h!]
			...
			\begin{minipage}{13em}
				\centering
				\includegraphics[scale = 0.03]{images/1_Cut_8.jpg}
				\caption{删除8}
			\end{minipage}
			\begin{minipage}{13em}
				\centering
				\includegraphics[scale = 0.03]{images/1_Cut_12.jpg}
				\caption{删除12}
			\end{minipage}
			\begin{minipage}{13em}
				\centering
				\includegraphics[scale = 0.03]{images/1_Cut_19.jpg}
				\caption{删除19}
			\end{minipage}
		\end{figure}
